...
var vm = new Vue({
	...
	methods: {
        ...
        getDept: function(){
            //加载部门树
            $.get(baseURL + "ams/class/classTree", function(r){
		...
		del: function () {
			...
			confirm('确定要删除选中的记录？', function(){
				$.ajax({
					type: "POST",
				    url: baseURL + "ams/student/delete",
		...
		saveOrUpdate: function () {
			var url = vm.user.userId == null ? "ams/student/save" : "ams/student/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
                contentType: "application/json",
		...
		getUser: function(userId){
			$.get(baseURL + "ams/student/info/"+userId, function(r){
				vm.user = r.user;
